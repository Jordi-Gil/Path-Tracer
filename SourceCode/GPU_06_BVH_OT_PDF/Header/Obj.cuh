...
public:
  ...
  __host__  Obj() {}
  __host__  Obj(int type, const std::string &filename, bool matB = false, Material m = Material(), bool _importanceSampling = false, int textureIndex = -1);
  ...
  __host__ bool isImportant(){return importanceSampling;}
