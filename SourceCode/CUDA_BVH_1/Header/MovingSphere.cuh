...
public:
	...
	__host__ __device__ void bounding_box(float t0, float t1, aabb& box) const;
    __host__ __device__ unsigned int getMorton() const;
    __host__ __device__ void setMorton(unsigned int code);
    __host__ __device__ aabb getBox() const;
    __host__ __device__ Vector3 getCenter() const;
