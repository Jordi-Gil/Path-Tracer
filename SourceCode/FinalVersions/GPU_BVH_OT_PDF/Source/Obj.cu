...
__host__  Obj::Obj(int type, const std::string &filename, bool mat, Material m, bool _importanceSampling, int textureIndex) {
  
  importanceSampling = _importanceSampling;
