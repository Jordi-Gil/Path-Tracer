...
namespace math {
  ...
  inline mat4 translate_matrix(const Vector3 v) {
  ...
  inline mat4 scale_matrix(const Vector3 v) {
  ...
  inline mat4 rotation_matrix(const float a, const Vector3 v) {
  ...
  inline mat4 translate(mat4 m, Vector3 v) {
    return m * translate_matrix(v);
  }
  
  inline mat4 scale(mat4 m, Vector3 v) {
  ...
  inline mat4 rotate(mat4 m, float ang, Vector3 v) {
