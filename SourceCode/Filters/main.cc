...
int main(int argc, char **argv) {
  ...
  if(filter){
    ...
    std::string filenameFiltered = image.substr(0, image.length()-4) + "_bilateral_filter_"+std::to_string(diameterBi)+"_"+std::to_string(gs)+"_"+std::to_string(gr)+".png";
    int sx, sy, sc;
    ...
    filenameFiltered = image.substr(0, image.length()-4) + "_median_filter_"+std::to_string(diameterMedian)+".png";
    ...
    filenameFiltered = image.substr(0, image.length()-4) + "_mean_filter_"+std::to_string(diameterMean)+".png";
