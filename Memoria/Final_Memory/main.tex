...
\begin{table}[H]
    ...
    \begin{tabular}{*{9}{|c}|}
		 ...
		 & &        	
         	...
         	& & &
         		Desktop & 9,01 & 90,48 & 451,49 & 916,96 & 1801,08\\ \clineB{3-9}{3.5}
         & &        	
         	\multirow{2}*{BVH Rec.} &
...
\begin{table}[H]
    ...
    \begin{tabular}{*{9}{|c}|}
         ...
         \multirow{18}*{GPU} & \multirow{18}*{\texttt{CUDA}} &
         	...
         	& & &
         		Desktop 		& 28,19 & 297,74 & 1473,80 & 2928,41 &  6178,08 \\ \cline{4-9}
         	& & &
		 ...
		 & &        	
         	...
         	& & &
         		BOADA - 4 GPU(s) 	& 4,83 & 36,34 & 178,22 & 353,11 & - 	\\ \clineB{3-9}{3.5}
         & &        	
         	\multirow{6}*{BVH Rec.} &
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[scale=0.1]{media/gantt/gannt_total.jpeg}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[scale=0.30]{media/gantt/gannt_gep.jpeg}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[scale=0.30]{media/gantt/gannt_dev.jpeg}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[scale=0.30]{media/gantt/gannt_final.jpeg}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Original image. 10 SPP}
  	\label{ap1}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Image filtered with window size $[11 \times 11]$. 10 SPP}
  	\label{ap2}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Image filtered with window size $[17 \times 17]$. 10 SPP}
  	\label{ap3}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Image filtered with window size $[21 \times 21]$. 10 SPP}
  	\label{ap4}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Original image. 50 SPP}
  	\label{ap5}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Image filtered with window size $[11 \times 11]$. 50 SPP}
  	\label{ap6}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Image filtered with window size $[17 \times 17]$. 50 SPP}
  	\label{ap7}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Image filtered with window size $[21 \times 21]$. 50 SPP}
  	\label{ap8}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 10$. 10 SPP}
	\label{ap17}
\end{figure}
...
\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 20$. 10 SPP}	
	\label{ap18}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 40$. 10 SPP}
	\label{ap19}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 60$. 10 SPP}	
	\label{ap20}
\end{figure}	
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 10$. 10 SPP}
	\label{ap21}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 20$. 10 SPP}
	\label{ap22}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 40$. 10 SPP}
	\label{ap23}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 60$. 10 SPP}
	\label{ap24}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 10$. 10 SPP}
	\label{ap25}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 20$. 10 SPP}
	\label{ap26}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 40$. 10 SPP}
	\label{ap27}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 60$. 10 SPP}
	\label{ap28}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 10$. 50 SPP}
	\label{ap29}
\end{figure}
...
\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 20$. 50 SPP}	
	\label{ap30}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 40$. 50 SPP}
	\label{ap31}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 5$ and $\delta_r = 60$. 50 SPP}	
	\label{ap32}
\end{figure}	
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 10$. 50 SPP}
	\label{ap33}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 20$. 50 SPP}
	\label{ap34}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 40$. 50 SPP}
	\label{ap35}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 10$ and $\delta_r = 60$. 50 SPP}
	\label{ap36}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 10$. 50 SPP}
	\label{ap37}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 20$. 50 SPP}
	\label{ap38}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 40$. 50 SPP}
	\label{ap39}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Image filtered with window size $[21 \times 21]$, $\delta_s = 15$ and $\delta_r = 60$. 50 SPP}
	\label{ap40}
\end{figure}
