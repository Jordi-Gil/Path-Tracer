...
\captionof{figure}{Diagrama de Gannt completo. Fuente: Propia}
\label{gantt}
\end{figure}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[scale=0.55]{media/gantt_1.png} %%width=.4\linewidth
...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{Primer ciclo. \\ Fuente: Propia}
  \label{gantt_2}
\end{minipage}
\end{figure}
...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{Segundo Ciclo. Fuente: Propia}
  \label{gantt_3}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[scale=0.75]{media/gantt_4.png}
  \captionof{figure}{Tercer ciclo. \\ Fuente: Propia}
  \label{gantt_4}
\end{minipage}
\end{figure}
...
\captionof{figure}{Cuarto ciclo y etapa final. \\ Fuente: Propia}
\label{gantt_5}
\end{figure}
