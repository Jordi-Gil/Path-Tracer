...
\begin{figure}[!ht]
	...
	\begin{subfigure}{.3\textwidth}
		...
		\caption{\textit{Ray Tracing}. Fuente: \citep{Cassagnabere2004}}
		\label{RT}
	\end{subfigure}
	
	\begin{subfigure}{.3\textwidth}
		\centering
		\includegraphics[width=.3\textwidth]{media/PathTracing.png}
		\caption{\textit{Path Tracing} con ruido. Fuente: \citep{Cassagnabere2004}}
		\label{PTN}
	\end{subfigure}
	\begin{subfigure}{.3\textwidth}
		\includegraphics[width=.3\textwidth]{media/PathTracingMD.png}	
		\caption{\textit{Path Tracing} sin ruido. Fuente: \citep{Cassagnabere2004}}
		\label{PT}
	\end{subfigure}
\end{figure}
...
\begin{figure}[H]
	...
	\captionof{figure}{Diagrama de Gantt completo. Fuente: Propia}
	\label{gantt}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Etapa de gestión. Fuente: Propia}
  	\label{gantt_1}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\captionof{figure}{Etapa de desarrollo. Fuente: Propia}
  	\label{gantt_2}
\end{figure}
